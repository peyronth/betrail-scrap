...
import scripts.logicourse as logicourse
...
supportedWebsites = {
    ...
    'logicourse (pdf) [backyard]' : {"script": logicourse.logicourse_pdf_backyard, "exampleUrl": "https://www.logicourse.fr/images/newsite/manifestations/pollionnay/pollionnay2023resu.pdf"},
